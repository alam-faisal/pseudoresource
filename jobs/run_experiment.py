...
def main(num_sites, chi, run_type, param=1.0, resume=False, max_iter=1e6, 
...
if __name__ == "__main__":
    ...
    max_iter = int(1e3)
    progress_interval = int(1e2)
    checkpoint_interval = int(1e2)

    main(num_sites, chi, run_type, param, resume, max_iter, progress_interval, checkpoint_interval)